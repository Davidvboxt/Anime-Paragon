import {  ImgDemonslayer, ImgOnepiecePlay, SvgImdb, SvgAge14, SvgArrow1 } from '../..'
...
function onepiece() {
    ...
    <>
        ...
        <div className='block__2'>
            <img className="embla__slide__img" src={ImgDemonslayer.src} alt="Logo" />
        </div>
        ...
        <div className='block__4'>
            <img className="embla__slide__img" src={ImgOnepiecePlay.src} alt="Logo" />
        </div>
